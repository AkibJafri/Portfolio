...
function About() {
    return (
        <div id="About" className="flex flex-col gap-y-4 gap-x-8 bg-indigo-900 p-8 lg:p-12 mt-20 bg-opacity-30 rounded-md shadow-sm mx-auto">
            ...
            <div className="flex flex-col xl:flex-row-reverse justify-center items-center">
                <div className="mx-auto my-auto xl:mr-0">
                    <div className="relative mx-auto flex justify-center items-center transition-all ">
                        ...
                        <div id="ppBg" className="h-44 w-44 lg:h-56 lg:w-56
                        ml-8 mt-8 lg:ml-12 lg:mt-12 bg-indigo-300 z-10 rounded-md shadow-xl  bg-opacity-50">
                        </div>

                        <div id="ppBg" className="absolute h-44 w-44 lg:h-56 lg:w-56
                    ...
                    <div className="flex justify-center gap-x-3 md:gap-x-4 lg:gap-x-5 xl:gap-x-6 my-10 lg:my-12 text-green-300">
                        <a href="https://www.frontendmentor.io/profile/thesohailjafri" target="_blank"><SiFrontendmentor size={30} /></a>
                        <a href="https://www.instagram.com/thesohailjafri" target="_blank"><SiInstagram size={30} /></a>
                        <a href="https://github.com/thesohailjafri" target="_blank"><SiGithub size={30} /></a>
                        <a href="https://www.linkedin.com/in/thesohailjafri" target="_blank"><SiLinkedin size={30} /></a>
                        <a href="https://twitter.com/thesohailjafri" target="_blank"><SiTwitter size={30} /></a>
                    </div>

                </div>
                <div className="flex flex-col gap-y-5 text-lg lg:text-xl text-indigo-300 max-w-3xl">
                    <p>
                        Hello! My name is <strong>Sohail</strong> and I enjoy creating everything web.
                        I started my web developer journey back in 2020 when I was working for my junior college capstone project which was<br />
                        <span className="text-green-300"> Online Lawyer Appointment Portal</span>.
                    </p>
                    <p>
                        Since then I have learned many things building and experimenting with websites and web apps via challenges from
                        <a href="https://www.frontendmentor.io/profile/thesohailjafri" target="_blank" className="text-green-300"> frontendmentor.io</a> or via personal projects.
                    </p>
                    <p>
                    ...
                    <div className="md:grid md:grid-cols-3">
                        <div>
                            <span className="hidden md:inline cursor-pointer text-lg text-green-300"><MdOutlineWeb size={20} className="text-indigo-300 inline mr-4 " />Front-end</span>
                        ...
                        <div>
                            <span className="hidden md:inline text-lg cursor-pointer text-green-300"><HiServer size={20} className="text-indigo-300 inline mr-4 " />Back-end</span>
                            <ul className="flex flex-col gap-y-1 mt-4">
                        ...
                        <div>
                            <span className="hidden md:inline cursor-pointer text-lg text-green-300"><MdDesignServices size={20} className="text-indigo-300 inline mr-4 " />Design</span>
                            <ul className="flex flex-col gap-y-1 mt-4">
