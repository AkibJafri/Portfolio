...
const proAry = [
  ...
  },
  {
    ...
    git: 'https://github.com/thesohailjafri/rock-paper-scissors-master',
    live: 'https://rock-paper-scissors-master-fm.netlify.app/',
    ...
    >
      <div className="flex flex-col gap-y-5 text-lg lg:text-xl text-indigo-300">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4">
          {proAry.map((val, i) => {
            return (
              <div className=" bg-indigo-900 bg-opacity-70 p-6 rounded shadow-sm flex flex-col transform translate-y-0 trasition-all duration-100 ease-out hover:-translate-y-2">
                <h5 className="text-indigo-100 text-lg lg:text-xl">
                  {val.name}
                </h5>
                <div className="inline-flex gap-x-4 text-base text-indigo-100 mb-4 mt-2">
                  {val.git && (
                    <a
                      ...
                      target="_blank"
                    >
                      <SiGithub size={20} className="text-green-300" />
                      Git
                    </a>
                  )}
                  {val.live && (
                    <a
                      ...
                      target="_blank"
                    >
                      <SiNetlify size={20} className="text-green-300" />
                      Live
                    </a>
                  )}
                </div>
